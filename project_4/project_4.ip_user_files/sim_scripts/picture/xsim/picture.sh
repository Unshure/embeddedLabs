...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot picture xil_defaultlib.picture -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim picture -key {Behavioral:sim_1:Functional:picture} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb picture.wdb xsim.dir)
