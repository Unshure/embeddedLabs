...
# module references:
# clock_div_112500, clock_div_25, controls, debounce, framebuffer, myALU, pixel_pusher, regs, uart, vga_ctrl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: clock_div_112500_0, and set properties
  set block_name clock_div_112500
  set block_cell_name clock_div_112500_0
  if { [catch {set clock_div_112500_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clock_div_112500_0 eq "" } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../instruction.coe} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
   CONFIG.Enable_A {Always_Enabled} \
   CONFIG.Load_Init_File {true} \
  ...
  connect_bd_net -net btn_0_1 [get_bd_ports btn0] [get_bd_pins debounce_0/btn]
  connect_bd_net -net clock_0_1 [get_bd_ports clk] [get_bd_pins clock_div_112500_0/clock] [get_bd_pins clock_div_25_0/clock] [get_bd_pins controls_0/clk] [get_bd_pins dMem/clka] [get_bd_pins debounce_0/clk] [get_bd_pins framebuffer_0/clk] [get_bd_pins irMem/clka] [get_bd_pins myALU_0/clk] [get_bd_pins pixel_pusher_0/clk] [get_bd_pins regs_0/clk] [get_bd_pins uart_0/clk] [get_bd_pins vga_ctrl_0/clk]
  connect_bd_net -net clock_div_112500_0_clk_div [get_bd_pins clock_div_112500_0/clk_div] [get_bd_pins controls_0/en] [get_bd_pins framebuffer_0/en1] [get_bd_pins myALU_0/en] [get_bd_pins regs_0/en] [get_bd_pins uart_0/en]
  connect_bd_net -net clock_div_25_0_clk_div [get_bd_pins clock_div_25_0/clk_div] [get_bd_pins framebuffer_0/en2] [get_bd_pins pixel_pusher_0/en] [get_bd_pins vga_ctrl_0/en]
  ...
  connect_bd_net -net controls_0_fb_en [get_bd_pins controls_0/fb_en] [get_bd_pins framebuffer_0/wr_en1]
  ...
  connect_bd_net -net controls_0_sendOut [get_bd_pins controls_0/sendOut] [get_bd_pins uart_0/send]
  ...
  connect_bd_net -net myALU_0_outputs [get_bd_pins controls_0/aluResult] [get_bd_pins myALU_0/outputs]
